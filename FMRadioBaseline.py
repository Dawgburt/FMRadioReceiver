...
class FMRadioBaseline(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FMRadio-PremadeBlocks", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FMRadio-PremadeBlocks")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FMRadioBaseline")
...
def main(top_block_cls=FMRadioBaseline, options=None):
